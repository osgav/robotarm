...
class ps3:
	...
	def __init__(self):
		...
		# get count of joysticks=1, axes=27, buttons=19 for DualShock 3
                #
                # ACTUALLY THE COUNTS ARE...
                # joysticks = 1
                # axes = 6
                # buttons = 17
                #
                # so I need to access [0] to [5] for button_analog joystick things later 
	...
	#	self.a_joystick_right_y	=button_analog[3]
                self.a_joystick_right_x =button_analog[3] # from previous testing I had right-joystick-x being interpreted as y (line above) this fixes that
                self.a_joystick_right_y =button_analog[4] # and so 4 must be y
	...
	#	self.acc_z				=button_analog[25]
		...
		self.joystick_left		=button_state[11]
		self.joystick_right		=button_state[12]
